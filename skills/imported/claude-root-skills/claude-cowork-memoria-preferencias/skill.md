---
name: claude-cowork-memoria-preferencias
description: Armazenamento e persistência das preferências de estilo de trabalho e restrições do usuário para sessões de IA. Acione sempre que mencionar salvar preferências, registrar estilo de trabalho, preferências do Claude, arquivo de memória ou preferências de resposta.
---

# 🧠 Claude Cowork - Criação de Memória de Preferências
...
- Alinhamento de comportamento automático: o Claude se adaptará sem que você precise reexplicar o contexto básico a cada nova sessão.
...
1. Grave as seguintes regras de comportamento para orientar todas as minhas próximas interações com o Claude:
