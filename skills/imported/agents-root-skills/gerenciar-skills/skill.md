...
Esta skill serve para ensinar o Codex CLI a criar e auditar novas habilidades locais no workspace (`E:\Projetos_Novos\.Codex\skills/`) de forma ágil, segura e altamente profissional.
...
2.  **Criar Diretório**: Crie a pasta em `E:\Projetos_Novos\.Codex\skills/<nome-da-skill>/`.
...
```bash
/auditar-skill e:\Projetos_Novos\.Codex\skills\<nome-da-skill>
```
Isso validará automaticamente a estrutura, segurança e conformidade da skill com as diretrizes do Codex!
